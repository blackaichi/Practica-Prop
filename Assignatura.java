...
public class Assignatura {
	 ...
	 */
		private boolean checkGrup(int numero) {
			for(Grup g : grups) {
	 ...
	 */
		private boolean checkSessioG(String tipus, int hores) {
			for(Sessio s : sessions) {
	 ...
	 */
		private boolean checkSessioSG(String tipus, int hores) {
			for(Sessio s : sessions) {
	 ...
	 */
		private boolean checkPlaEstudis(String nom) {
	 ...
	 */
		public SessioGrup getSessioG(String tipus, int hores) {
			for(Sessio s: sessions)
				if(s.getTipus() == tipus && s.getHores() == hores) return s.getSessioG(tipus,hores);
			return null;
		}
	 ...
	 */
		public SessioSubGrup getSessioSG(String tipus, int hores) {
			for(Sessio s: sessions)
				if(s.getTipus() == tipus && s.getHores() == hores) return s.getSessioSG(tipus,hores);
			return null;
		}
	 ...
	 * @return Excepció codificada en forma d'enter.
	 */
		public int altaSessio(String tipus, int hores) {
	 ...
	 * @return Excepció codificada en forma d'enter.
	 */
		public int altaPlaEstudis(String nom) {
